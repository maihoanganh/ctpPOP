function test_correlative_POP_ball(n::Int64,umin::Int64,umax::Int64,eqcons::Bool)
    k=2
    ...
    for u in umin:5:umax
        @time begin
        n,m,l,lmon_g,supp_g,coe_g,lmon_h,supp_h,coe_h,lmon_f,supp_f,coe_f,dg,dh=correlative_POP_ball(n,u,k,eqcons=eqcons)
        ...
        println()
        try
            @time cs_tssos_first(Vector{SparseMatrixCSC{UInt8,UInt32}}([[supp_f];supp_g;supp_h]),[[coe_f];coe_g;coe_h],n,k,[dg;dh],numeq=l,CS="MD",TS=false,CTP=true)
        catch 
...
function correlative_POP_ball(n::Int64,u::Int64,k::Int64;eqcons::Bool=false)
