...
function lmbm(optFun::Function,x::Array{Float64};na::Int=2,mcu::Int=5,printinfo::Bool=false,maxtime::Float64=300000.0,tol::Float64=1e-7,maxiter::Int64=5000000)


  global fOptPtr = @cfunction($optFun,Cdouble,(Cint,Ptr{Cdouble}, Ptr{Cdouble}))
  ccall((:set_obj_func,liblmbm),Cvoid,(Ptr{Cvoid},),fOptPtr)

  ipar=convert(Array{Cint},[0,maxiter,5000000,0,4,0,0])
 
  rpar=convert(Array{Cdouble},[tol,tol,tol,tol,tol,0.5,1e-5,1])
