function model_mix_CGAL(n::Int64,m::Int64,l::Int64,lmon_g::Vector{UInt64},supp_g::Vector{SparseMatrixCSC{UInt64}},coe_g::Vector{Vector{Float64}},lmon_h::Vector{UInt64},supp_h::Vector{SparseMatrixCSC{UInt64}},coe_h::Vector{Vector{Float64}},lmon_f::Int64,supp_f::SparseMatrixCSC{UInt64},coe_f::Vector{Float64},dg::Vector{Int64},dh::Vector{Int64},k::Int64,t::Int64;UseEq::Bool=true)
    ...
    a_val,a0,norm_a0,opnorm_a=rescale_mix_CGAL(a_ind1,a_ind2,a_val,a_len,a0,zeta)
...
function rescale_mix_CGAL(a_ind1::Vector{UInt64},a_ind2::Vector{UInt64},a_val::Vector{Float64},a_len::UInt64,a0::Vector{Float64},zeta::UInt64)
...
function SmallEig_mix_CGAL(mat::Matrix{Float64},s::UInt64;EigAlg="Arpack")
    if s==1
...
function SmallEig_block_mix_CGAL(vec::Adjoint{Float64,Array{Float64,1}},sk::UInt64;EigAlg::String="Arpack")
    ...
    return SmallEig_mix_CGAL(B,sk,EigAlg=EigAlg)
end


function SmallEigBlocks_mix_CGAL(a0_block::Vector{Adjoint{Float64,Array{Float64,1}}},a_block::Array{SparseMatrixCSC{Float64,Ti} where Ti<:Integer,1},y::Vector{Float64},s::Vector{UInt64},omega::Int64;EigAlg::String="Arpack")
    ...
    @fastmath @inbounds @simd for t in 1:omega
        eigval,eigvec=SmallEig_block_mix_CGAL(a0_block[t]+y'*a_block[t],s[t],EigAlg=EigAlg)
...
function update_mix_CGAL(y::Vector{Float64},z::Vector{Float64},val::Float64,t::Float64,a_block::Array{Array{SparseMatrixCSC{Float64,Ti} where Ti<:Integer,1},1},a0_block::Vector{Vector{Adjoint{Float64,Array{Float64,1}}}},s_cliq::Vector{Vector{UInt64}},omega_cliq::Vector{Int64},norm_a0::Float64,opnorm_a::Float64,ak::Float64,p::Int64,zeta::UInt64;EigAlg::String="Arpack")
    ...
    @fastmath @inbounds @simd for j in 1:p
        eigval,eigvec,ind=SmallEigBlocks_mix_CGAL(a0_block[j],a_block[j],q,s_cliq[j],omega_cliq[j],EigAlg=EigAlg)
        dualval+=eigval
        eigmat=get_vec_CGAL(eigvec,s_cliq[j][ind])
...
function solve_mix_CGAL(omega_cliq::Vector{Int64},a0_block::Vector{Vector{Adjoint{Float64,Array{Float64,1}}}},a_block::Array{Array{SparseMatrixCSC{Float64,Ti} where Ti<:Integer,1},1},s_cliq::Vector{Vector{UInt64}},zeta::UInt64,norm_a0::Float64,opnorm_a::Float64,ak::Float64,p::Int64;EigAlg::String="Arpack",maxit::Float64=1e6,tol::Float64=1e-4)
    ...
    @fastmath @inbounds for t in 1:maxit
        y,z,val,feas,gap=update_mix_CGAL(y,z,val,t,a_block,a0_block,s_cliq,omega_cliq,norm_a0,opnorm_a,ak,p,zeta,EigAlg=EigAlg)
        if feas<tol && gap<tol
...
function POP_mix_CGAL(n::Int64,m::Int64,l::Int64,lmon_g::Vector{UInt64},supp_g::Vector{SparseMatrixCSC{UInt64}},coe_g::Vector{Vector{Float64}},lmon_h::Vector{UInt64},supp_h::Vector{SparseMatrixCSC{UInt64}},coe_h::Vector{Vector{Float64}},lmon_f::Int64,supp_f::SparseMatrixCSC{UInt64},coe_f::Vector{Float64},dg::Vector{Int64},dh::Vector{Int64},k::Int64,t::Int64;EigAlg::String="Arpack",maxit::Float64=1e3,tol::Float64=1e-3,UseEq::Bool=true)

    @time begin
    
    
    @time omega_cliq,a0_block,a_block,s_cliq,zeta,norm_a0,opnorm_a,ak,p=model_mix_CGAL(n,m,l,lmon_g,supp_g,coe_g,lmon_h,supp_h,coe_h,lmon_f,supp_f,coe_f,dg,dh,k,t,UseEq=UseEq)

      
    @time opt_val=solve_mix_CGAL(omega_cliq,a0_block,a_block,s_cliq,zeta,norm_a0,opnorm_a,ak,p,maxit=maxit,EigAlg=EigAlg,tol=tol)
